...
namespace Coupa_Invoice_Model
{
    public class CoupaInvoice
    {
        ...
        public string LineLevelTaxation { get; set; }
        ...
        public string SupplierTotal { get; set; }
        ...
        public CoupaInvoice(string id, string createdAt, string updatedAt, string invoiceDate, 
            string invoiceNumber, string lineLevelTaxation, string status, string totalWithTaxes, 
            string grossTotal, string supplierTotal, string taxRate, string taxAmount, string paymentDate, 
            string paymentNotes, string exported, string lastExportedAt, string originalInvoiceDate, 
            string clearanceDocument, string documentType, string originalInvoiceNumber, string isCreditNote, string lineCount, 
