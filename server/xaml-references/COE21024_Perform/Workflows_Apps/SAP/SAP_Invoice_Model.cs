...
namespace SAP_Invoice_Model
{
    public class SAPInvoice
    {
        ...
        [JsonProperty("PostingDateExport")]
        public string PostingDateExport { get; set; }
        ...
        public SAPInvoice(string belnr, string companyCode, string document, string documentDate, string postingDate, string postingDateExport,  string currency, string reference, 
            string originalInvNum, string originalInvDate, string vendorAccNumber, double VendorDocCurrencyHeader, string paymentTerms, string IMFCode, SAPInvoiceItem[] invoiceItemsArray)
        {
            ...
            this.PostingDateExport = postingDateExport;
