...
function buildFallbackRegistry(): Record<string, ActivityRegistryEntry> {
  ...
  return {
    ...
    "ui:GetCredential": stubReq("UiPath.Credentials.Activities", ["Target"], ["AssetName", "Username", "Password"]),
    "GetCredential": stubReq("UiPath.Credentials.Activities", ["Target"], ["AssetName", "Username", "Password"]),
...
const UI_PREFIX_ACTIVITY_PACKAGE_MAP: Record<string, string> = {
  ...
  "ui:GetCredential": "UiPath.Credentials.Activities",
  "ui:GetCredentials": "UiPath.Credentials.Activities",
