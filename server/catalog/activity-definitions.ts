...
const PERSISTENCE_ACTIVITIES: PackageActivityDefs = {
  ...
  activities: [
    ...
    {
      className: "ReadStorageText",
      displayName: "Read Storage Text",
      browsable: true,
      emissionApproved: true,
      processTypes: ["general", "orchestration"],
      properties: [
        childProp("Path", { type: "System.String", wrapper: "InArgument", typeArgs: "x:String", required: true }),
        childProp("StorageBucketName", { type: "System.String", wrapper: "InArgument", typeArgs: "x:String" }),
        childProp("Content", { dir: "Out", type: "System.String", wrapper: "OutArgument", typeArgs: "x:String" }),
        COMMON_CONTINUE_ON_ERROR,
      ],
    },
    {
      className: "WriteStorageText",
      ...
      properties: [
        childProp("Path", { type: "System.String", wrapper: "InArgument", typeArgs: "x:String", required: true }),
        childProp("StorageBucketName", { type: "System.String", wrapper: "InArgument", typeArgs: "x:String" }),
        childProp("Content", { type: "System.String", wrapper: "InArgument", typeArgs: "x:String" }),
        COMMON_CONTINUE_ON_ERROR,
      ],
    },
    ...
    {
      className: "UploadStorageFile",
      displayName: "Upload Storage File",
      browsable: true,
      emissionApproved: true,
      processTypes: ["general", "orchestration"],
      properties: [
        childProp("Destination", { type: "System.String", wrapper: "InArgument", typeArgs: "x:String", required: true }),
        childProp("FileResource", { type: "System.String", wrapper: "InArgument", typeArgs: "x:String" }),
        childProp("Path", { type: "System.String", wrapper: "InArgument", typeArgs: "x:String" }),
        childProp("StorageBucketName", { type: "System.String", wrapper: "InArgument", typeArgs: "x:String" }),
        COMMON_CONTINUE_ON_ERROR,
      ],
    },
...
const SYSTEM_CORE_ACTIVITIES_ENRICHED: PackageActivityDefs = {
  ...
  activities: [
    ...
    },
    {
      ...
      propertiesComplete: true,
      properties: [
        childProp("Input", { type: "System.String", wrapper: "InArgument", typeArgs: "x:String", required: true }),
        prop("Pattern", { required: true }),
        prop("RegexOption", { type: "System.Text.RegularExpressions.RegexOptions", default: "None" }),
        childProp("Result", { dir: "Out", type: "System.Boolean", wrapper: "OutArgument", typeArgs: "x:Boolean" }),
      ],
    },
    {
