...
**Total Estimated Effort: ~160 minutes (2.7 hours)**
**Remediations:** 12 total (0 property, 0 activity, 0 sequence, 0 structural-leaf, 1 workflow)
**Auto-Repairs:** 13
**Quality Warnings:** 46
...
| 3 | `Dispatcher.xaml` | Fully Generated |
| 4 | `Performer.xaml` | Fully Generated |
| 5 | `ProcessEvent.xaml` | Structurally invalid — [EXPRESSION_SYNTAX_UNFIXABLE] Line 359: Possible missing comma or operator between ")" and "CStr(" — check expression syntax in expression: CType(obj_ContactSearchResult("results")(0)("person")("emailAddresses"), Newtons... |
| 6 | `GenerateGreeting.xaml` | Fully Generated |
| 7 | `Finalise.xaml` | Fully Generated |
| 8 | `BirthdayGreetingsV12.xaml` | Fully Generated |
| 9 | `InitAllSettings.xaml` | Structurally invalid (not Studio-loadable) |
| 10 | `[Init.xaml].xaml` | Fully Generated |
| 11 | `[Dispatcher.xaml].xaml` | Fully Generated |
| 12 | `[Performer.xaml].xaml` | Fully Generated |
| 13 | `[Finalise.xaml].xaml` | Fully Generated |
...
| 3 | `Dispatcher.xaml` | Studio-openable | — | — |
| 4 | `Performer.xaml` | Openable with warnings | Unclassified | — |
| 5 | `ProcessEvent.xaml` | Structurally invalid — not Studio-loadable | Unclassified | [EXPRESSION_SYNTAX_UNFIXABLE] Line 359: Possible missing comma or operator be... |
| 6 | `GenerateGreeting.xaml` | Openable with warnings | Unclassified | — |
| 7 | `Finalise.xaml` | Openable with warnings | Unclassified | — |
...
| 12 | `[Performer.xaml]` | Openable with warnings | Unclassified | — |
| 13 | `[Finalise.xaml]` | Openable with warnings | Unclassified | — |

**Summary:** 4 Studio-loadable, 8 with warnings, 1 not Studio-loadable
...
|---|------|------|-------------|-------------|
| 1 | `REPAIR_PLACEHOLDER_CLEANUP` | `ProcessEvent.xaml` | Stripped 2 placeholder token(s) from ProcessEvent.xaml | 5 |
| 2 | `REPAIR_PLACEHOLDER_CLEANUP` | `GenerateGreeting.xaml` | Stripped 1 placeholder token(s) from GenerateGreeting.xaml | 5 |
| 3 | `REPAIR_CATALOG_PROPERTY_SYNTAX` | `Performer.xaml` | Catalog: Moved While.Condition from attribute to child-element in Performer.xaml | undefined |
| 4 | `REPAIR_CATALOG_PROPERTY_SYNTAX` | `ProcessEvent.xaml` | Catalog: Moved ForEach.Values from attribute to child-element in ProcessEvent.xaml | undefined |
| 5 | `REPAIR_CATALOG_PROPERTY_SYNTAX` | `GenerateGreeting.xaml` | Catalog: Moved While.Condition from attribute to child-element in GenerateGreeting.xaml | undefined |
...
| 13 | `REPAIR_TYPE_MISMATCH` | `Performer.xaml` | Object variable "obj_TransactionItem" cannot be retyped to generic interface UiPath.Core.QueueIte... | undefined |

## 3. Manual Action Required

### Validation Issues — Requires Manual Attention (11)
...
|---|------|-------|-----------------|-------------|
| 1 | `Init.xaml` | `UNDECLARED_VARIABLE` | Manually implement activity in Init.xaml — estimated 15 min | 15 |
| 2 | `Init.xaml` | `UNDECLARED_VARIABLE` | Manually implement activity in Init.xaml — estimated 15 min | 15 |
| 3 | `ProcessEvent.xaml` | `EXPRESSION_SYNTAX_UNFIXABLE` | Manually implement activity in ProcessEvent.xaml — estimated 15 min | 15 |
| 4 | `ProcessEvent.xaml` | `UNDECLARED_VARIABLE` | Manually implement activity in ProcessEvent.xaml — estimated 15 min | 15 |
| 5 | `ProcessEvent.xaml` | `UNDECLARED_VARIABLE` | Manually implement activity in ProcessEvent.xaml — estimated 15 min | 15 |
| 6 | `GenerateGreeting.xaml` | `UNDECLARED_VARIABLE` | Manually implement activity in GenerateGreeting.xaml — estimated 15 min | 15 |
| 7 | `GenerateGreeting.xaml` | `UNDECLARED_VARIABLE` | Manually implement activity in GenerateGreeting.xaml — estimated 15 min | 15 |
| 8 | `Finalise.xaml` | `UNDECLARED_VARIABLE` | Manually implement activity in Finalise.xaml — estimated 15 min | 15 |
| 9 | `Performer.xaml` | `OBJECT_TO_IENUMERABLE` | Manually implement activity in Performer.xaml — estimated 15 min | 15 |
| 10 | `Finalise.xaml` | `ENUM_VIOLATION` | Fix enum value for activity in Finalise.xaml — use valid enum from UiPath doc... | 5 |
| 11 | `Finalise.xaml` | `ENUM_VIOLATION` | Fix enum value for activity in Finalise.xaml — use valid enum from UiPath doc... | 5 |
...
|---|------|------|-----------------|-------------|
| 1 | `InitAllSettings.xaml` | `STUB_WORKFLOW_BLOCKING` | Fix XML structure in InitAllSettings.xaml — ensure proper nesting and closing... | 15 |

### Developer Implementation Required (14)
...
| 3 | `Performer.xaml` | Contains 2 placeholder value(s) matching "\bTODO\b" [Developer Implementation Required] | 10 |
| 4 | `Performer.xaml` | Contains 2 placeholder value(s) matching "\bPLACEHOLDER\b" [Developer Implementation Required] | 10 |
| 5 | `ProcessEvent.xaml` | Contains 7 placeholder value(s) matching "\bTODO\b" [Developer Implementation Required] | 10 |
| 6 | `ProcessEvent.xaml` | Contains 7 placeholder value(s) matching "\bPLACEHOLDER\b" [Developer Implementation Required] | 10 |
| 7 | `GenerateGreeting.xaml` | Contains 4 placeholder value(s) matching "\bTODO\b" [Developer Implementation Required] | 10 |
| 8 | `GenerateGreeting.xaml` | Contains 4 placeholder value(s) matching "\bPLACEHOLDER\b" [Developer Implementation Required] | 10 |
| 9 | `Finalise.xaml` | Contains 1 placeholder value(s) matching "\bTODO\b" [Developer Implementation Required] | 10 |
| 10 | `Finalise.xaml` | Contains 1 placeholder value(s) matching "\bPLACEHOLDER\b" [Developer Implementation Required] | 10 |
| 11 | `[Init.xaml]` | Contains 1 placeholder value(s) matching "\bTODO\b" [Developer Implementation Required] | 10 |
| 12 | `[Dispatcher.xaml]` | Contains 1 placeholder value(s) matching "\bTODO\b" [Developer Implementation Required] | 10 |
| 13 | `[Performer.xaml]` | Contains 1 placeholder value(s) matching "\bTODO\b" [Developer Implementation Required] | 10 |
| 14 | `[Finalise.xaml]` | Contains 1 placeholder value(s) matching "\bTODO\b" [Developer Implementation Required] | 10 |

### Quality Warnings (32)

| # | File | Check | Detail | Developer Action | Est. Minutes |
|---|------|-------|--------|-----------------|-------------|
| 1 | `Init.xaml` | hardcoded-asset-name | Line 120: asset name "&quot;BGV12.CalendarName&quot;" is hardcoded — consider using a Config.xlsx... | — | undefined |
| 2 | `Init.xaml` | hardcoded-asset-name | Line 163: asset name "&quot;BGV12.Timezone&quot;" is hardcoded — consider using a Config.xlsx ent... | — | undefined |
| 3 | `Init.xaml` | hardcoded-asset-name | Line 205: asset name "&quot;BGV12.FromGmailConnectionName&quot;" is hardcoded — consider using a ... | — | undefined |
| 4 | `Init.xaml` | hardcoded-asset-name | Line 247: asset name "&quot;BGV12.MaxConnectorRetries&quot;" is hardcoded — consider using a Conf... | — | undefined |
| 5 | `Init.xaml` | hardcoded-asset-name | Line 289: asset name "&quot;BGV12.RetryBackoffSeconds&quot;" is hardcoded — consider using a Conf... | — | undefined |
| 6 | `Init.xaml` | hardcoded-asset-name | Line 331: asset name "&quot;BGV12.SkipOnAmbiguousContactMatch&quot;" is hardcoded — consider usin... | — | undefined |
| 7 | `Init.xaml` | hardcoded-asset-name | Line 373: asset name "&quot;BGV12.PreferredEmailLabels&quot;" is hardcoded — consider using a Con... | — | undefined |
| 8 | `Init.xaml` | hardcoded-asset-name | Line 415: asset name "&quot;BGV12.SendEnabled&quot;" is hardcoded — consider using a Config.xlsx ... | — | undefined |
| 9 | `Init.xaml` | hardcoded-asset-name | Line 457: asset name "&quot;BGV12.OperationsDL&quot;" is hardcoded — consider using a Config.xlsx... | — | undefined |
| 10 | `Performer.xaml` | hardcoded-queue-name | Line 142: queue name "BirthdayGreetingsV12_EmailsToSend" is hardcoded — consider using a Config.x... | — | undefined |
| 11 | `ProcessEvent.xaml` | hardcoded-retry-count | Line 176: retry count hardcoded as 3 — consider externalizing to Config.xlsx (e.g., in_Config("Ma... | — | undefined |
| 12 | `ProcessEvent.xaml` | hardcoded-retry-interval | Line 176: retry interval hardcoded as "00:00:05" — consider externalizing to Config.xlsx | — | undefined |
...
| 23 | `InitAllSettings.xaml` | BARE_TOKEN_QUOTED | Auto-quoted bare token "Settings" for uexcel:ExcelReadRange.SheetName (expected String type) — wr... | — | undefined |
| 24 | `InitAllSettings.xaml` | BARE_TOKEN_QUOTED | Auto-quoted bare token "Constants" for uexcel:ExcelReadRange.SheetName (expected String type) — w... | — | undefined |
| 25 | `ProcessEvent.xaml` | CATALOG_VIOLATION | Missing required property "Endpoint" on uis:IntegrationServiceHTTPRequest | — | undefined |
| 26 | `ProcessEvent.xaml` | CATALOG_VIOLATION | Missing required property "JsonString" on uweb:DeserializeJson | — | undefined |
| 27 | `ProcessEvent.xaml` | CATALOG_VIOLATION | Missing required property "Result" on uweb:DeserializeJson | — | undefined |
| 28 | `GenerateGreeting.xaml` | CATALOG_VIOLATION | Missing required property "Prompt" on ugenai:UseGenAI | — | undefined |
| 29 | `GenerateGreeting.xaml` | CATALOG_VIOLATION | Missing required property "JsonString" on uweb:DeserializeJson | — | undefined |
| 30 | `GenerateGreeting.xaml` | CATALOG_VIOLATION | Missing required property "Result" on uweb:DeserializeJson | — | undefined |
| 31 | `Finalise.xaml` | CATALOG_VIOLATION | Missing required property "Endpoint" on uis:IntegrationServiceHTTPRequest | — | undefined |
| 32 | `ProcessEvent.xaml` | RETRY_INTERVAL_DEFAULTED | Post-repair: RetryInterval defaulted to "00:00:05" — verify this is appropriate for the workflow ... | — | undefined |

**Total manual remediation effort: ~160 minutes (2.7 hours)**
...
**Total:** 18 activities (9 hardcoded, 9 variable-driven)
...
|------|------|----------|-----------------|------|----------|----------|
| `Init.xaml` | 120 | GetAsset | `BGV12.CalendarName` | Unknown | — | Yes |
| `Init.xaml` | 121 | GetAsset | `UNKNOWN` | Unknown | — | No |
| `Init.xaml` | 163 | GetAsset | `BGV12.Timezone` | Unknown | — | Yes |
| `Init.xaml` | 164 | GetAsset | `UNKNOWN` | Unknown | — | No |
| `Init.xaml` | 205 | GetAsset | `BGV12.FromGmailConnectionName` | Unknown | — | Yes |
| `Init.xaml` | 206 | GetAsset | `UNKNOWN` | Unknown | — | No |
| `Init.xaml` | 247 | GetAsset | `BGV12.MaxConnectorRetries` | Unknown | — | Yes |
| `Init.xaml` | 248 | GetAsset | `UNKNOWN` | Unknown | — | No |
| `Init.xaml` | 289 | GetAsset | `BGV12.RetryBackoffSeconds` | Unknown | — | Yes |
| `Init.xaml` | 290 | GetAsset | `UNKNOWN` | Unknown | — | No |
| `Init.xaml` | 331 | GetAsset | `BGV12.SkipOnAmbiguousContactMatch` | Unknown | — | Yes |
| `Init.xaml` | 332 | GetAsset | `UNKNOWN` | Unknown | — | No |
| `Init.xaml` | 373 | GetAsset | `BGV12.PreferredEmailLabels` | Unknown | — | Yes |
| `Init.xaml` | 374 | GetAsset | `UNKNOWN` | Unknown | — | No |
| `Init.xaml` | 415 | GetAsset | `BGV12.SendEnabled` | Unknown | — | Yes |
| `Init.xaml` | 416 | GetAsset | `UNKNOWN` | Unknown | — | No |
| `Init.xaml` | 457 | GetAsset | `BGV12.OperationsDL` | Unknown | — | Yes |
| `Init.xaml` | 458 | GetAsset | `UNKNOWN` | Unknown | — | No |
...
|---|------|------|--------|-----------|----------|----------|
| 1 | `BGV12.CalendarName` | asset | **Aligned** | type: Text, value: Birthdays, description: Google Calendar name containing birthday events. | `Init.xaml` | 120 |
| 2 | `BGV12.Timezone` | asset | **Aligned** | type: Text, value: Asia/Dubai, description: Authoritative timezone for 'today' evaluation and schedule alignment. | `Init.xaml` | 163 |
| 3 | `BGV12.FromGmailConnectionName` | asset | **Aligned** | type: Text, value: ninemush@gmail.com, description: Integration Service Gmail connection name used to send greetings. | `Init.xaml` | 205 |
| 4 | `BGV12.MaxConnectorRetries` | asset | **Aligned** | type: Integer, value: 3, description: Max retries for transient Integration Service connector failures (Calendar/People/Gmail). | `Init.xaml` | 247 |
| 5 | `BGV12.RetryBackoffSeconds` | asset | **Aligned** | type: Integer, value: 10, description: Backoff delay between transient retries. | `Init.xaml` | 289 |
| 6 | `BGV12.SkipOnAmbiguousContactMatch` | asset | **Aligned** | type: Bool, value: true, description: If multiple contacts match the same name, skip to avoid mis-send; log as business exception. | `Init.xaml` | 331 |
| 7 | `BGV12.PreferredEmailLabels` | asset | **Aligned** | type: Text, value: personal,home, description: Comma-separated preferred email labels (case-insensitive). | `Init.xaml` | 373 |
| 8 | `BGV12.SendEnabled` | asset | **Aligned** | type: Bool, value: true, description: Master kill-switch for outbound email sending (when false, generate content but do not send). | `Init.xaml` | 415 |
| 9 | `BGV12.OperationsDL` | asset | **Aligned** | type: Text, value: , description: Optional distribution list to receive failure notifications (left blank as PDD states no notifications). | `Init.xaml` | 457 |
| 10 | `BGV12.GoogleWorkspaceCredential` | credential | **SDD Only** | type: Credential, description: Reserved credential asset for break-glass scenarios; primary auth is via Integration Service connections. | — | — |
...
| 12 | `&quot;BirthdayGreetingsV12_EmailsToSend&quot;` | queue | **XAML Only** | — | `Performer.xaml` | 142 |
...
|---|-----------|------------|-----------------|------------|-----|--------|
| 1 | `&quot;BirthdayGreetingsV12_EmailsToSend&quot;` | GetTransactionItem | Recommended | Yes (3x) | — | Create in Orchestrator |
...
**Coverage:** 24/24 high-risk activities inside TryCatch (100%)
...
|------|----------|-------|----------------|
| placeholder-value | warning | 14 | Contains 2 placeholder value(s) matching "\bTODO\b" [Developer Implementation Required] |
| hardcoded-asset-name | warning | 19 | Line 120: asset name "&quot;BGV12.CalendarName&quot;" is hardcoded — consider using a Config.xlsx entry or workflow argu... |
| hardcoded-queue-name | warning | 1 | Line 142: queue name "BirthdayGreetingsV12_EmailsToSend" is hardcoded — consider using a Config.xlsx entry or workflow a... |
| hardcoded-retry-count | warning | 1 | Line 176: retry count hardcoded as 3 — consider externalizing to Config.xlsx (e.g., in_Config("MaxRetryNumber")) |
| hardcoded-retry-interval | warning | 1 | Line 176: retry interval hardcoded as "00:00:05" — consider externalizing to Config.xlsx |
...
| 4 | Assets | Provision asset: `BGV12.CalendarName` | Yes |
| 5 | Assets | Provision asset: `BGV12.Timezone` | Yes |
| 6 | Assets | Provision asset: `BGV12.FromGmailConnectionName` | Yes |
| 7 | Assets | Provision asset: `BGV12.MaxConnectorRetries` | Yes |
| 8 | Assets | Provision asset: `BGV12.RetryBackoffSeconds` | Yes |
| 9 | Assets | Provision asset: `BGV12.SkipOnAmbiguousContactMatch` | Yes |
| 10 | Assets | Provision asset: `BGV12.PreferredEmailLabels` | Yes |
| 11 | Assets | Provision asset: `BGV12.SendEnabled` | Yes |
| 12 | Assets | Provision asset: `BGV12.OperationsDL` | Yes |
| 13 | Queues | Create queue: `&quot;BirthdayGreetingsV12_EmailsToSend&quot;` | Yes |
...
| Build Quality | 0/10 | 46 quality warnings — significant remediation needed; 12 remediations — stub replacements need developer attention; 12/13 workflow(s) are Studio-loadable (1 blocked — 8% not loadable) |
...
| Metric | Count |
|---|---|
| Total activities checked | 250 |
| Valid activities | 250 |
| Unknown → Comment stubs | 0 |
| Non-catalog properties stripped | 37 |
...
|---|---|
| Pre-emission (spec validation) | 39 auto-fixed, 35 total issues |
| Post-emission (quality gate) | 58 warnings/remediations |
...
```json
{
  ...
  "autoRepairs": [
    {
      ...
      "description": "Stripped 2 placeholder token(s) from ProcessEvent.xaml",
      "developerAction": "Review ProcessEvent.xaml for Comment elements marking where placeholder activities were removed",
      "estimatedEffortMinutes": 5
    },
    {
      "repairCode": "REPAIR_PLACEHOLDER_CLEANUP",
      "file": "GenerateGreeting.xaml",
      "description": "Stripped 1 placeholder token(s) from GenerateGreeting.xaml",
      "developerAction": "Review GenerateGreeting.xaml for Comment elements marking where placeholder activities were removed",
      "estimatedEffortMinutes": 5
    },
    {
    ...
    },
    {
      "repairCode": "REPAIR_CATALOG_PROPERTY_SYNTAX",
      "file": "ProcessEvent.xaml",
      "description": "Catalog: Moved ForEach.Values from attribute to child-element in ProcessEvent.xaml"
    },
    {
      "repairCode": "REPAIR_CATALOG_PROPERTY_SYNTAX",
      "file": "GenerateGreeting.xaml",
      "description": "Catalog: Moved While.Condition from attribute to child-element in GenerateGreeting.xaml"
    },
    {
      "repairCode": "REPAIR_CATALOG_PROPERTY_SYNTAX",
    ...
    },
    {
      ...
      "file": "Performer.xaml",
      "description": "Object variable \"obj_TransactionItem\" cannot be retyped to generic interface UiPath.Core.QueueItem — requires a concrete collection type"
    }
  ],
  "remediations": [
    {
    ...
    },
    {
      ...
      "file": "ProcessEvent.xaml",
      "remediationCode": "STUB_ACTIVITY_UNKNOWN",
      "reason": "Line 359: Possible missing comma or operator between \")\" and \"CStr(\" — check expression syntax in expression: CType(obj_ContactSearchResult(\"results\")(0)(\"person\")(\"emailAddresses\"), Newtons...",
      "classifiedCheck": "EXPRESSION_SYNTAX_UNFIXABLE",
      "developerAction": "Manually implement activity in ProcessEvent.xaml — estimated 15 min",
      "estimatedEffortMinutes": 15
    },
    {
      "level": "validation-finding",
      "file": "ProcessEvent.xaml",
      "remediationCode": "STUB_ACTIVITY_UNKNOWN",
      "reason": "Line 449: Undeclared variable \"emailEntry\" in expression: emailEntry.Split(\"|\"c)(0) — variable is not declared in any <Variable> block in scope",
      "classifiedCheck": "UNDECLARED_VARIABLE",
      "developerAction": "Manually implement activity in ProcessEvent.xaml — estimated 15 min",
      "estimatedEffortMinutes": 15
    },
    {
      ...
      "file": "ProcessEvent.xaml",
      "remediationCode": "STUB_ACTIVITY_UNKNOWN",
      "reason": "Line 457: Undeclared variable \"emailEntry\" in expression: If(emailEntry.Split(\"|\"c).Length &gt; 1, emailEntry.Split(\"|... — variable is not declared in any <Variable> block in scope",
      "classifiedCheck": "UNDECLARED_VARIABLE",
      "developerAction": "Manually implement activity in ProcessEvent.xaml — estimated 15 min",
      "estimatedEffortMinutes": 15
    },
    {
      ...
      "file": "GenerateGreeting.xaml",
      "remediationCode": "STUB_ACTIVITY_UNKNOWN",
      "reason": "Line 121: Undeclared variable \"subject\" in expression: \"Write a short birthday email in my voice: warm, funny, sarc... — variable is not declared in any <Variable> block in scope",
      "classifiedCheck": "UNDECLARED_VARIABLE",
      "developerAction": "Manually implement activity in GenerateGreeting.xaml — estimated 15 min",
      "estimatedEffortMinutes": 15
    },
    {
      "level": "validation-finding",
      "file": "GenerateGreeting.xaml",
      "remediationCode": "STUB_ACTIVITY_UNKNOWN",
      "reason": "Line 121: Undeclared variable \"body\" in expression: \"Write a short birthday email in my voice: warm, funny, sarc... — variable is not declared in any <Variable> block in scope",
      "classifiedCheck": "UNDECLARED_VARIABLE",
      "developerAction": "Manually implement activity in GenerateGreeting.xaml — estimated 15 min",
      "estimatedEffortMinutes": 15
    },
    {
      ...
      "file": "Finalise.xaml",
      "remediationCode": "STUB_ACTIVITY_UNKNOWN",
      "reason": "Line 102: Undeclared variable \"Completed\" in expression: str_DerivedStatus &lt;&gt; Completed — variable is not declared in any <Variable> block in scope",
      "classifiedCheck": "UNDECLARED_VARIABLE",
      "developerAction": "Manually implement activity in Finalise.xaml — estimated 15 min",
      "estimatedEffortMinutes": 15
    },
    {
      "level": "validation-finding",
      "file": "Performer.xaml",
      "remediationCode": "STUB_ACTIVITY_UNKNOWN",
      "reason": "Line 358: Variable \"obj_TransactionItem\" (System.Object) bound to ui:SetTransactionStatus.TransactionItem (expects UiPath.Core.QueueItem). Retype the variable to a concrete collection type.",
    ...
    },
    {
      ...
      "reason": "ENUM_VIOLATION: Invalid value \"[If(bool_HasErrors, Warn, Info)]\" for \"Level\" on ui:LogMessage — valid values: Trace, Info, Warn, Error, Fatal. No normalization match found.",
      "classifiedCheck": "ENUM_VIOLATION",
      "developerAction": "Fix enum value for activity in Finalise.xaml — use valid enum from UiPath documentation",
      "estimatedEffortMinutes": 5
    },
    {
      "level": "validation-finding",
      "file": "Finalise.xaml",
      "remediationCode": "STUB_ACTIVITY_CATALOG_VIOLATION",
      "reason": "ENUM_VIOLATION: Invalid value \"[If(str_DerivedStatus = Faulted, Fatal, If(str_DerivedStatus = CompletedWithErrors, Warn, Info))]\" for \"Level\" on ui:LogMessage — valid values: Trace, Info, Warn, Error, Fatal. No normalization match found.",
      "classifiedCheck": "ENUM_VIOLATION",
      "developerAction": "Fix enum value for activity in Finalise.xaml — use valid enum from UiPath documentation",
      "estimatedEffortMinutes": 5
    },
  ...
  "qualityWarnings": [
    ...
    },
    {
      ...
      "file": "Init.xaml",
      "detail": "Line 120: asset name \"&quot;BGV12.CalendarName&quot;\" is hardcoded — consider using a Config.xlsx entry or workflow argument",
      "severity": "warning"
    },
    {
      "check": "hardcoded-asset-name",
      "file": "Init.xaml",
      "detail": "Line 163: asset name \"&quot;BGV12.Timezone&quot;\" is hardcoded — consider using a Config.xlsx entry or workflow argument",
      "severity": "warning"
    },
    {
      "check": "hardcoded-asset-name",
      "file": "Init.xaml",
      "detail": "Line 205: asset name \"&quot;BGV12.FromGmailConnectionName&quot;\" is hardcoded — consider using a Config.xlsx entry or workflow argument",
      "severity": "warning"
    },
    {
      "check": "hardcoded-asset-name",
      "file": "Init.xaml",
      "detail": "Line 247: asset name \"&quot;BGV12.MaxConnectorRetries&quot;\" is hardcoded — consider using a Config.xlsx entry or workflow argument",
      "severity": "warning"
    },
    {
      "check": "hardcoded-asset-name",
      "file": "Init.xaml",
      "detail": "Line 289: asset name \"&quot;BGV12.RetryBackoffSeconds&quot;\" is hardcoded — consider using a Config.xlsx entry or workflow argument",
      "severity": "warning"
    },
    {
      "check": "hardcoded-asset-name",
      "file": "Init.xaml",
      "detail": "Line 331: asset name \"&quot;BGV12.SkipOnAmbiguousContactMatch&quot;\" is hardcoded — consider using a Config.xlsx entry or workflow argument",
      "severity": "warning"
    },
    {
      "check": "hardcoded-asset-name",
      "file": "Init.xaml",
      "detail": "Line 373: asset name \"&quot;BGV12.PreferredEmailLabels&quot;\" is hardcoded — consider using a Config.xlsx entry or workflow argument",
      "severity": "warning"
    },
    {
      "check": "hardcoded-asset-name",
      "file": "Init.xaml",
      "detail": "Line 415: asset name \"&quot;BGV12.SendEnabled&quot;\" is hardcoded — consider using a Config.xlsx entry or workflow argument",
      "severity": "warning"
    },
    {
      "check": "hardcoded-asset-name",
      "file": "Init.xaml",
      "detail": "Line 457: asset name \"&quot;BGV12.OperationsDL&quot;\" is hardcoded — consider using a Config.xlsx entry or workflow argument",
      "severity": "warning"
    },
    {
      "check": "hardcoded-queue-name",
      "file": "Performer.xaml",
      "detail": "Line 142: queue name \"BirthdayGreetingsV12_EmailsToSend\" is hardcoded — consider using a Config.xlsx entry or workflow argument",
      "severity": "warning"
    },
    {
  ...
  "totalEstimatedEffortMinutes": 160,
  "studioCompatibility": [
    {
      "file": "Main.xaml",
    ...
    },
    {
      ...
      "blockers": [
        "[EXPRESSION_SYNTAX_UNFIXABLE] Line 359: Possible missing comma or operator between \")\" and \"CStr(\" — check expression syntax in expression: CType(obj_ContactSearchResult(\"results\")(0)(\"person\")(\"emailAddresses\"), Newtons..."
      ]
    },
    {
      "file": "GenerateGreeting.xaml",
